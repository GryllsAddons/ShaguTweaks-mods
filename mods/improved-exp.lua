...
module.enable = function(self)
    ...
    expFrame:RegisterEvent("PLAYER_ENTERING_WORLD")
    expFrame:RegisterEvent("UPDATE_EXHAUSTION")
    expFrame:RegisterEvent("PLAYER_ENTERING_WORLD")
    expFrame:RegisterEvent("PLAYER_XP_UPDATE")
    expFrame:RegisterEvent("UPDATE_FACTION")

    expFrame:SetScript("OnEvent", function()
