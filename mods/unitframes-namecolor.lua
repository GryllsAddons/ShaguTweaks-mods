...
module.enable = function(self)
    ...
    local colorName = CreateFrame("Frame", nil, UIParent)
    colorName:RegisterEvent("PLAYER_ENTERING_WORLD")    
    colorName:RegisterEvent("PLAYER_TARGET_CHANGED")
    colorName:RegisterEvent("PARTY_MEMBERS_CHANGED")
    colorName:RegisterEvent("UNIT_PET", "player")

    colorName:SetScript("OnEvent", function()
