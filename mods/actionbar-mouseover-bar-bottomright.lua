local module = ShaguTweaks:register({
    ...
    description = "Hide the Bottom Right ActionBar and show on mouseover. The pet/shapeshift/aura/stance bars will not be clickable when using with 'Reduced Actionbar'. The action bar must be enabled in 'Interface Options' > 'Advanced Options'. Please reload the UI after enabling or disabling the action bar.",
