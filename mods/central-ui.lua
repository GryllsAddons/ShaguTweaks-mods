local module = ShaguTweaks:register({
  ...
  module.enable = function(self)
    ...
    local function unitframes()    
        ...
        PlayerFrame:SetPoint("RIGHT", UIParent, "CENTER", -xoffset, yoffset)
        
        -- Target
        TargetFrame:ClearAllPoints()
        TargetFrame:SetScale(scale)
        TargetFrame:SetPoint("LEFT", UIParent, "CENTER", xoffset, yoffset)
    ...
    local moveFrame = CreateFrame("Frame", nil, UIParent)	
    moveFrame:RegisterEvent("PLAYER_ENTERING_WORLD")

    moveFrame:SetScript("OnEvent", function()
