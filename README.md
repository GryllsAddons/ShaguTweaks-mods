...
### basic-chat
Creates General, Combat Log and 'Loot & Spam' chat boxes and setup chat channels.<br>
The mod create and reposition the chat boxes and setup channels on every login unless disabled.
